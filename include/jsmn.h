...
/*
 * MIT License - JSMN JSON Parser
 * Copyright (c) 2010-2020 Serge Zaitsev
 * Included in Argo with attribution
 */
...
/* JSON error codes */
enum jsmnerr {
    JSMN_ERROR_NOMEM = -1,  /* Not enough memory */
...
typedef struct jsmn_parser {
    ...
    int toksuper;          /* parent token index */
} jsmn_parser;
...
static int jsmn_parse_primitive(jsmn_parser *parser, const char *js,
    ...
    (void)num_tokens;  /* Unused parameter */
    jsmntok_t *token;
    int start;
