...
/* Test Harness: Control Flow
 *
 * Purpose: Test workflow control flow with decide and user_choose
 * Tests:
 *   - decide step (conditional branching)
 *   - user_choose step (menu selection)
...
int main(void) {
    ...
    workflow_controller_t* workflow = workflow_create(registry, lifecycle, "control-flow-test");
    ...
    /* Load workflow */
    printf("Loading workflow: workflows/test/control_flow_test.json\n\n");
    int result = workflow_load_json(workflow, "workflows/test/control_flow_test.json");
